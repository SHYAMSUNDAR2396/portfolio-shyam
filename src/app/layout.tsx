...
export const metadata: Metadata = {
  title: "M SHYAM SUNDAR",
  description:
    "M SHYAM SUNDAR is a proficient Software Engineer and Full Stack Developer from India, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  "M Shyam Sundar",
  "shyam sundar",
  "shyam-sundar developer",
  "shyam full stack developer",
  ...
  "nixlab shyam",
  "mshyamsundar",
  "m shyam sundar github",
  "shyam nixlab",
  "shyam sundar portfolio",
  "nextjs react developer india",
